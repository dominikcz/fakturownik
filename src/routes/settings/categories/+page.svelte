...
<style>
	...
	.btn-secondary:hover:not(:disabled) { background: var(--clr-surface-hover); }
	.btn-sm { padding: 5px 8px; font-size: 0.8rem; }
	.btn-ghost { background: transparent; color: var(--clr-text-muted); }
	.btn-ghost:hover { background: var(--clr-bg); color: var(--clr-text-2); }
	.btn-ghost.danger:hover { background: var(--clr-danger-hover-bg); color: var(--clr-danger); }
</style>
